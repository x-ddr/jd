...
!(async () => {
    ...
    if (pKHelpAuthorFlag) {
        let res = [], res2 = [], res3 = [];
        try {
            res = await getAuthorShareCode('http://gh.tryxd.cn/https://github.com/x-dr/shareCodeList/blob/main/innerPkInviteList.json');
        }catch (e) {
            res = []
        }
        // res2 = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/gitupdate/updateTeam@master/shareCodes/jd_zoo.json');
        res3 = await getAuthorShareCode('http://gh.tryxd.cn/https://github.com/x-dr/shareCodeList/blob/main/innerPkInviteList.json');
